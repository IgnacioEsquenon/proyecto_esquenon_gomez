...
<div class="container mt-5 text-light">
     <?php helper('form'); ?>
    <?php echo form_open_multipart('actualizar/'. $producto["id"])?>

        <div class="mb-3">
            <label for="nombre_producto">Nombre del Producto</label>
            <?php echo form_input(['name' => 'nombre_producto', 'id' => 'nombre_producto','type' =>'text','class' => 'form-control','value' =>set_value('nombre_producto', $producto["nombre_producto"])]); ?>
        ...
        <div class="mb-3">
            ...
            <?php echo form_input(['name' => 'imagen_producto', 'id' => 'imagen_producto','type' =>'file', 'class' => 'form-control','value' =>set_value('imagen_producto', $producto["imagen_producto"])]); ?>
        ...
        <div class="mb-3">
            ...
            <?php echo form_input(['name' => 'precio', 'id' => 'precio','type' =>'number', 'class' => 'form-control','value' =>set_value('precio', $producto["precio"])]); ?>
        ...
        <div class="mb-3">
            ...
            <?php echo form_input(['name' => 'marca', 'id' => 'marca','type' =>'text', 'class' => 'form-control','value' =>set_value('marca', $producto["marca"])]); ?>
        ...
        <div class="mb-3">
            ...
            <?php echo form_input(['name' => 'stock', 'id' => 'stock','type' =>'number', 'class' => 'form-control','value' =>set_value('stock', $producto["stock"])]); ?>
        ...
        <div class="mb-3">
            ...
            <?php echo form_textarea(['name' => 'descripcion', 'id' => 'descripcion', 'class' => 'form-control','value' =>set_value('descripcion', $producto["descripcion"])]); ?>
             <?php if(isset($validation) && $validation->hasError('descripcion')): ?>
                <div class="text-danger"><?= $validation->getError('descripcion') ?></div>
            <?php endif; ?>
        </div>

        <?php echo form_submit('Actualizar Producto', 'Actualizar Producto', "class='btn btn-success mt-3'") ?>
        <?php echo form_close(); ?> 
